...
if __name__ == "__main__":
    grammar = {
        ...
        "Sentencia": [["Imprimir", "(", "Expresion", ")"],
                      ...
                      ["Break"]],
        "Funcion": [["Func", "Tipo", "Identificador", "(", "Parametros", ")", "{", "ListaSentencias", "RetornoOpcional", "}"]],
        ...
        "ListaSentencias": [["Sentencia"], [EPSILON]],
        ...
        "Expresion": [["Termino", "OperacionOpcional"]],
        "Termino": [["Identificador", "OperacionSecundaria"], ["(", "Expresion", ")"]],
        "OperacionOpcional": [["OperadorAritmetico", "Expresion"], [EPSILON]],
        "OperacionSecundaria": [["OperadorAritmetico", "Termino"], [EPSILON]],
        "AsignacionOpcional": [[EPSILON], ["OperadorAritmetico", "Identificador"], [",", "Parametros"]],
